...
- 状態: in progress
- 次にやること: これまでの内容を組み合わせた小さな復習課題に取り組む
...
- [ ] class を使って小さなモデルを書ける
- [ ] 配列をループして処理できる
- [ ] 関数または method に責務を分けられる
- [ ] `match` または `if` を適切に使える
- [ ] これまでの内容を組み合わせて1つの小さなCLIプログラムにできる
