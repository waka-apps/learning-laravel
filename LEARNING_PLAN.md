...
- 理解確認を出す前に `PROGRESS.md` の該当チェック項目とセッションログを見て、すでに完了済みの論点をそのまま再質問しない
- 再確認が必要な場合は、同じ質問を繰り返すのではなく、今回の課題で新しく増えた論点に接続して聞く
...
- `PROGRESS.md` は「次に進むレッスン」だけでなく「すでに完了しているため再確認不要な論点」の判定にも使う
