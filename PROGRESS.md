...
- 現在のレッスン: Day 4 - 配列と連想配列
- 状態: in progress
- 次にやること: list と連想配列を最小コードで見比べる
...
- [ ] listとしての配列を書ける
- [ ] 連想配列を書ける
- [ ] 添字アクセスとキーアクセスの違いを説明できる
- [ ] PHPの配列が list と map の両方に使われると説明できる
- [ ] 配列の形が崩れると危険な理由を1つ説明できる
